...
# Attributes and their vectors for each movie
attributes = ["fantastical", "emotional", "temporal"]
attribute_vectors =  {
    "The Clockwork Archivist": {"fantastical": 5, "emotional": 3, "temporal": 5},
    "Paper Kingdoms": {"fantastical": 5, "emotional": 3, "temporal": 4},
    "The Silent Cartographer": {"fantastical": 5, "emotional": 3, "temporal": 4},
    "Ashes of the Oracle": {"fantastical": 5, "emotional": 4, "temporal": 5},
    "The Glass Apothecary": {"fantastical": 4, "emotional": 5, "temporal": 2},
    "Hollow Crown": {"fantastical": 5, "emotional": 4, "temporal": 4},
    "Song of Rust": {"fantastical": 5, "emotional": 3, "temporal": 3},
    "Ink & Bone Dust": {"fantastical": 5, "emotional": 3, "temporal": 4},
    "Weepers of the Tide": {"fantastical": 5, "emotional": 4, "temporal": 2},
    "Gilded Shadows": {"fantastical": 4, "emotional": 4, "temporal": 2},
    "Starlight Ciphers": {"fantastical": 5, "emotional": 3, "temporal": 4},
    "The Seventh Door": {"fantastical": 5, "emotional": 3, "temporal": 5},
    "Ember & Epitaph": {"fantastical": 5, "emotional": 4, "temporal": 3},
    "Violet Harvest": {"fantastical": 5, "emotional": 5, "temporal": 3},
    "Clocktower Orphans": {"fantastical": 5, "emotional": 3, "temporal": 5},
    "Marble Saints": {"fantastical": 5, "emotional": 4, "temporal": 2},
    "Relic of the Fallen Sky": {"fantastical": 5, "emotional": 3, "temporal": 4},
    "The Bone Court": {"fantastical": 5, "emotional": 3, "temporal": 3},
    "Lanterns of Nowhere": {"fantastical": 5, "emotional": 4, "temporal": 4},
    "Frostbitten Psalms": {"fantastical": 5, "emotional": 4, "temporal": 5}
}
...
def recommend_top3(user_vector, attribute_vectors, attributes, top_n=3):
    scores = []
    for book, vec in attribute_vectors.items():
        # build the attribute vector in the correct order
        v = [vec[attr] for attr in attributes]
        score = cosine(user_vector, v)
        scores.append((book, score))
    # sort and return top N
    return sorted(scores, key=lambda x: x[1], reverse=True)[:top_n]

def main():
    for uv in test_vectors:
        top3 = recommend_top3(uv, attribute_vectors, attributes)
        print(f"\nUser preference vector: {uv}")
        for rank, (book, score) in enumerate(top3, start=1):
            print(f"  {rank}. {book}  (score: {score:.3f})")
